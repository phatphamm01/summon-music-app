  ...
  <html lang="en">
    ...
    <body class="bg-gray-900">
      <div class="mobile">
        <div class="box shadow-md">
          <div class="flex flex-col h-full">
            <header
              class="container-m w-full flex justify-between items-center mt-4"
            >
              <div class="box__left">
            ...
            <main class="flex flex-col overflow-hidden flex-grow">
              ...
              <section class="mt-5 flex-grow flex overflow-hidden">
                <div class="w-full container-m flex flex-col">
                  <h4 class="title uppercase">Bảng xếp hạng</h4>
              ...
              <section class="mt-10">
                <div class="container-m container__play">
                  <div class="play">
                    <span id="play-name" class="play__name"
                      >Xứng đôi cưới thôi</span
                    >
                    ...
                    <div
                      class="play__time flex justify-between font-light mt-1"
                    >
                      <span class="play__time-start" id="time-current"
                        >00:00</span
                      >
                      <span class="play__time-end" id="time-duration"
                        >00:00</span
                      >
                    </div>
                  </div>
      ...
      <script
        ...
        type="text/babel"
      ></script>
      <script defer crossorigin src="${pageContext.request.contextPath}/assets/js/top.js" type="text/babel"></script>
    </body>
  </html>
</html>
